...
export default function App() {
  ...
  const booksRes = [
    ...
    },
    {
      ...
      volumeInfo: {
        ...
        subtitle:
          "How Blockchain, Cryptocurrency, and Token-Economy Are Disrupting the Financial World",
    ...
    },
    {
      ...
      volumeInfo: {
        ...
        imageLinks: {
          ...
          thumbnail:
            "http://books.google.com/books/content?id=GR7dDwAAQBAJ&printsec=frontcover&icmg=1&zoom=1&edge=curl&source=gbs_api",
        },
        language: "en",
        previewLink:
  ...
  return (
    <div className="p-6">
      ...
      <h1 className="py-3 font-extrabold text-3xl">Books Data :</h1>
      <div className="flex gap-4 flex-wrap">
        {booksRes.map((book, index) => (
